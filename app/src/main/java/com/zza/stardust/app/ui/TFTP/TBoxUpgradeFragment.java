...
public class TBoxUpgradeFragment extends MFragment {
    ...
    protected int createViewLayoutId() {
        return R.layout.fragment_tbox_upgrade;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.bt_start:
                ...
                } else if (!((TFTPActivity) getActivity()).getPermission()) {
    ...
    private void startUpgrade() {
        if (progressDialog == null)
            progressDialog = ProgressDialog.show(getActivity(), "提示", "正在传输升级文件", false, false);
        tvResult.setText("");
