package com.zza.stardust.app.ui.androidart.bitmapcache;
...
import com.zza.stardust.app.ui.androidart.bitmapcache.loader.ImageLoader;
...
public class BitmapCacheActivity extends MActivity implements OnScrollListener {
    ...
    protected void onInit(Bundle savedInstanceState) {
        ...
        initData();
        initView();
        mImageLoader = ImageLoader.build(BitmapCacheActivity.this);
    }
